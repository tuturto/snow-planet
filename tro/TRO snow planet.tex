...
Low gravity coupled with relatively normal surface temperature makes Kakkuri
ideal place to operate mining machinery. Because of close proximity of the
Kiiminki and thin atmosphere, radiation levels can be quite high from time to
time. Kakkuri seems to lack magnetic field that would protect it from the
radiation. All vehicles have to be shielded against the radiation and
personnel operating outside have to wear bulky protective suits.

Surface of the Kakkuri is dotted with impact craters and ragged mountain
regions. Evidence suggests that the planet had very intense volcanic activity
at some point during its life time, but that has ceased. Cooled down magma
vents reaching to surface are common and often filled with precious minerals.
Saarinen mining has estabilished small mining colony around one of the largest
vents.
...
be rarer. Inhabitants have learned to deal with the harsh weather and their
settlements are often build party under the snow and ice. Temperature there
is more constant and buildings are proctected from strong storm winds that
sometimes rage for days.
...
\newthought{Current prime minister} of Kingdom of Kiiminki is long time
...
\newthought{Minister of Mining} and Natural Resources is important position in
...
\newthought{Her Royal Majesty} Queen \'{A}sd\'{i}s IV is the current monarch
...
\newthought{Ragnhei\dh ur Sigurdsdottir} has been the commander of the 4th
...
\newthought{Government Structure} has three main parts in Kingdom of Kiiminki:
monarch, riksdagen and government.

\newthought{Monarch} is the head of the kingdom and chief of Kiiminki Armed
Forces. He has veto right to decisions made by riksdagen and government.
Monarch has wide powers, being able to change, enforce and interpret the
legislation. The title of monarch is hereditary and in normal circumstances
inherited by the eldest child.

Current monarch is Queen \'{A}sd\'{i}s IV and her husband is Prince Johannes.

\newthought{Riksdagen} is national legislature and supreme decision-making
body of Kingdom of Kiiminki. It has 349 members, that are selected in a
general election by the citizens of Kiiminki.

\newthought{Government} is the supreme excecutive authority in Kingdom of 
Kiiminki. It has 19 ministers. Prime minister is appointed by riksdagen. Rest
of the ministers are appointed by prime minister. Current cabinet is as
follows:

\begin{description}
  \item[prime minister] Kai Hansen
  \item[deputy prime minister] Kerstin Alfsson
  \item[minister of finance] Dagur \'{O}skarsson
  \item[minister of foreign affairs] Lovise Losnedahl
  \item[minister of agriculture] Matti Kaipoinen

  \item[minister of defence] Lorens Lager
  \item[minister of education] Halld\'{o}ra Freyrsdottir
  \item[minister of health] Njord Vollan
  \item[minister of industry] Signe Sinason
  \item[minister of interior] Petteri Iso-Kyr\"{o}

  \item[minister of justice] Mathis Bj\"{o}rk
  \item[minister of mining and natural resources] Marja-Liisa Laamatta
  \item[minister of science] Nj\'{a}la Hrafnsdottir
  \item[minister of commerce] Thorvald Erickson
  \item[minister of communications] Laura Matilainen

  \item[minister of energy] Ismo Saastamoinen
  \item[minister of labour] Johannes Stendahl
  \item[minister of transport] \DH \'{o}rir Bjarnisson
  \item[minister of environment] Niina Soinni
\end{description}

\newthought{Judiciary} of Kingdom of Kiiminki consists of common courts,
high courts and supreme court. Their responsibility is to interpret the law
and in some rare cases change them.

\marginnote{Supreme court may change a law if it is found to be in conflict
with higher norm (primary legislation or international law)}
...
\newthought{Religion} doesn't play major role in Kiiminki. There is no state
...
\newthought{Education} plays an integral role in Kingdom of Kiiminki. State
...
\newthought{Arts} are practiced, but with very practical approach. People of
...
\newthought{5th Stalwart Defence} is mechanized infantry division mainly
...
\newthought{Commander of the 5th Stalwart Defence} is Brigadier General Edda
\'{O}lafursdottir. While the 5th Stalward Defence isn't as highly acclaimed
as some other units in KAF, Brigadier General \'{O}lafursdottir is very
motivated to maintain its combat readiness. She demands very high attention to
detail in every matter and has very methodical approach to fighting a war.

\newthought{Tactics of 5th Stalward Defence} are focused on defensive combat
and working in urban environment. They are experts at stopping and destroying
both armor and 'mech forces alike.
...
\ovalbox{
  \begin{minipage}{10cm}
    ...
    Mechanized Infantry Regiment / Regular / Reliable

    CO: Colonel Sanna Rautiainen

    The 25th 'Mech Busters is especially adept at fighting against 'Mech
    forces. They cleverly exploit all the cover that urban environment gives
    and ambush opposing force 'Mech units from multiple directions.
\end{minipage}}

\begin{marginfigure}[0\baselineskip]
  \includegraphics[width=3cm]{rocket}
  \caption{The insignia of 25th 'Mech Busters}
  \label{fig:mech-busters}
\end{marginfigure}
...
\ovalbox{
  \begin{minipage}{10cm}
    ...
    CO: Colonel Niklas Lundgren

    26th Triple Skulls specializes in close quarter combat in urban areas.
    They are called in when the opposing force has gained a stronghold and is
    refusing to budge, not matter what.
\end{minipage}}

\begin{marginfigure}[0\baselineskip]
  \includegraphics[width=3cm]{triple-skulls}
  \caption{The insignia of 26th Triple Skulls}
  \label{fig:triple-skulls}
\end{marginfigure}
...
\ovalbox{
  \begin{minipage}{10cm}
    ...
    CO: Colonel Vilhj\'{a}lmur Fri\dh riksson

    27th Pyromaniacs have high concentration of flame weapons in their
    disposal and they are well trained to use them. As a result, they are
    extremely capable in urban combat.
\end{minipage}}

\begin{marginfigure}[0\baselineskip]
  \includegraphics[width=3cm]{fire-bomb}
  \caption{The insignia of 27th Pyromaniacs}
  \label{fig:pyromaniacs}
\end{marginfigure}

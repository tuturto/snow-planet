...
\marginnote[+1.8cm]{DGR-1 uses standard armour, which protects it well against
...
\newthought{Digger 1D} is a I.C.E. version of the earlier Digger 1
model. I.C.E. and commercial armour are quite a bit cheaper and there
is no too big drop in the performance. As a result 1D is very popular
model, especially in the operations that have very limited resource
pool.
...
\newthought{Digger 1F} is a fuel-cell variant of the earlier Digger 1
model. Performance is on par with the DGR-1 model in all other areas

...
\begin{marginfigure}[0\baselineskip]
  \includegraphics[width=3cm]{army_service}
...
\begin{marginfigure}[0\baselineskip]
  \includegraphics[width=3cm]{aerospace_great_coat}
  \caption{Standard AeroSpace service uniform with great coat}
...
\newthought{Kuiper Sniper School} is one of the smallest combat school in KAF.
...
Lundgren. She is proud to serve as the commander of such a venerated unit and is

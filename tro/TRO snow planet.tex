...
\newthought{Captains} \marginnote{Doctors trained by the Medical Corps often
have rank of Surgeon Captain, even when they aren't surgeons per se.} are
...
\newthought{Brigadier General} - divisions

\newthought{Major General} - field army (rarely)

\newthought{General} - military branch
